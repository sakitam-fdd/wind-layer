...
var BaiduWindy = function (_global$BMap$Overlay) {
  inherits(BaiduWindy, _global$BMap$Overlay);

  function BaiduWindy(data) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    classCallCheck(this, BaiduWindy);
  ...
  BaiduWindy.prototype.getData = function getData() {
    return this.data;
  };

  BaiduWindy.prototype._getExtent = function _getExtent() {
  ...
  BaiduWindy.prototype.appendTo = function appendTo(map) {
    if (map) {
      map.addOverlay(this);
    } else {
  ...
  BaiduWindy.prototype.initialize = function initialize(map) {
    var _this2 = this;
  ...
  BaiduWindy.prototype.adjustSize = function adjustSize() {
    var size = this._map.getSize();
  ...
  BaiduWindy.prototype.draw = function draw() {
    var self = this;
  ...
  BaiduWindy.prototype._draw = function _draw() {
    var map = this._map;
  ...
  BaiduWindy.prototype.render = function render(canvas) {
  ...
  BaiduWindy.prototype.getContainer = function getContainer() {
    return this.canvas;
  };

  BaiduWindy.prototype.setZIndex = function setZIndex(zIndex) {
    this.zIndex = zIndex;
    this.canvas.style.zIndex = this.zIndex;
  };

  BaiduWindy.prototype.getZIndex = function getZIndex() {
    return this.zIndex;
  };
