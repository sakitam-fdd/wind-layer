...
export default class ScalarFill {
  ...
  public render(camera: PerspectiveCamera, offsetX = 0) {
    if (this.data && this.program && this.data.texture && this.colorRampTexture) {
      const uniforms: any = {
        u_opacity: utils.isNumber(this.opacity) ? this.opacity : 1,
      ...
      if (this.options.renderForm === 'rg') {
        ...
        const speeds = [
          ...
          Math.sqrt(this.data.uMin! * this.data.uMin! + this.data.vMin! * this.data.vMin!),
          Math.sqrt(this.data.uMin! * this.data.uMin! + this.data.vMax! * this.data.vMax!),
          Math.sqrt(this.data.uMax! * this.data.uMax! + this.data.vMax! * this.data.vMax!),
          Math.sqrt(this.data.uMax! * this.data.uMax! + this.data.vMin! * this.data.vMin!),
